...
class ProductsBloc extends Bloc<ProductsEvent, ProductsState> {
  ...
  Future<void> _onSelectRestaurant(
    ...
    if (state is RestaurantsLoaded) {
      ...
      try {
        final products = await _apiService.getRestaurantProducts(event.restaurantId);
        emit(ProductsLoaded(currentState.restaurants, event.restaurantId, products));
      } catch (e) {
        emit(ProductsError(currentState.restaurants, event.restaurantId, 'Failed to load products: $e'));
      }
